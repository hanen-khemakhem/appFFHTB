...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => 'user', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-01-11 16:02:51',
                'modified' => '2019-01-11 16:02:51'
            ],
        ];
        parent::init();
    }
